...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "daepool@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "daepool API";

        private String description = "daepool API documentation";
